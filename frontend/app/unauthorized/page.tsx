        ...
        <main className="min-h-screen bg-background flex items-center justify-center p-6">
            ...
            <ShieldAlert size={14} />
                ...
                <p className="text-muted-foreground text-base mb-10 leading-relaxed">
                    ...
                    Certifique-se de estar logado com a conta correta ou entre em contato com o suporte.
                </p>
                ...
                <div className="flex flex-col gap-3">
                    {/* <Button 
            onClick={() => router.()}
            className="w-full h-12 bg-primary text-primary-foreground font-bold rounded-radius flex items-center justify-center gap-2 hover:opacity-90 transition-all"
          >
            <ArrowLeft size={18} />
